...
@Component({
  ...
  templateUrl: './metagenomics.component.html',
  styleUrl: './metagenomics.component.scss'
})

export class MetagenomicsComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.analysisParameters.addControl("type", new FormControl("metagenomics"));
